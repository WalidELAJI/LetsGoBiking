 ...
 * 
 */
@WebServiceClient(name = "SoapService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:8083/SoapService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8083/SoapService?wsdl");
     ...
     * 
     * @return
     *     returns InterfaceSoap
     */
    @WebEndpoint(name = "BasicHttpBinding_InterfaceSoap")
    public InterfaceSoap getBasicHttpBindingInterfaceSoap() {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_InterfaceSoap"), InterfaceSoap.class);
    }
     ...
     */
    @WebEndpoint(name = "BasicHttpBinding_InterfaceSoap")
    public InterfaceSoap getBasicHttpBindingInterfaceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_InterfaceSoap"), InterfaceSoap.class, features);
    }
