...
namespace MapProject.Proxy
{
    ...
    public class ProxyService : InterfaceProxy
    {
        ...
        private readonly CacheService<List<Station>> cacheJCDecaux = new CacheService<List<Station>>(TimeSpan.FromMinutes(10));
        public async Task<List<Station>> GetStationsJcdecaux(string city)
        {
